...
export function StudioScreen() {
  ...
  const selectTemplate = (id: string) => {
    setSelectedId(id)
    /* On narrow layouts the detail panel is below the catalogue — move focus
       to its heading so keyboard and screen-reader users land on the update. */
        ...
        >
          <div className="border-b border-border-soft px-3 py-3">
            <h2
              ...
              className="text-[13px] font-bold tracking-wide text-text uppercase"
            >
              ...
              <div className="grid grid-cols-1 gap-2 sm:grid-cols-3">
                ...
                <div>
                  ...
                  <select
                    ...
                    value={reviewLevel}
                    onChange={(event) => setReviewLevel(event.target.value as DocRiskLevel | 'all')}
                    className={SELECT_CLASS}
                  >
                    <option value="all">{t('doclib_studio_all')}</option>
