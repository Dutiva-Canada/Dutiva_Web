 ...
 *
 * A decision tree over completed-tenure bands, not a free-form number pad.
 * Each outcome states the **statutory floor weeks** for that band only —
 * the same values `lookupStatutoryNoticeWeeks('ON', …)` returns. Common-law
 * reasonable notice is deliberately not estimated.
 *
 ...
 *
 * Colocated `statutoryNoticeOntario.test.ts` asserts every outcome weeks
 * figure matches the grounded table so copy cannot drift from the lookup.
 */
...
export const statutoryNoticeOntarioFlow: Flow = {
  ...
  steps: [
    ...
    },
    {
      ...
      body: bi(
        'For this tenure band, the ESA s. 57 statutory floor is 1 week of notice (or pay in lieu). Treat this as a minimum to meet or exceed — not as the right answer for every case. Common-law reasonable notice is often higher. Verify tenure and the statute before issuing a letter.',
        'Pour cette tranche d’ancienneté, le plancher légal de l’art. 57 de la LNE est de 1 semaine de préavis (ou d’indemnité). Traitez-le comme un minimum à respecter ou dépasser — pas comme la bonne réponse dans tous les cas. Le préavis raisonnable de common law est souvent plus élevé. Vérifiez l’ancienneté et la loi avant d’émettre une lettre.',
      ),
      documents: ['T03'],
    },
    {
      ...
      body: bi(
        'For this tenure band, the ESA s. 57 statutory floor is 2 weeks of notice (or pay in lieu). Treat this as a minimum to meet or exceed — not as the right answer for every case. Common-law reasonable notice is often higher. Verify tenure and the statute before issuing a letter.',
        'Pour cette tranche d’ancienneté, le plancher légal de l’art. 57 de la LNE est de 2 semaines de préavis (ou d’indemnité). Traitez-le comme un minimum à respecter ou dépasser — pas comme la bonne réponse dans tous les cas. Le préavis raisonnable de common law est souvent plus élevé. Vérifiez l’ancienneté et la loi avant d’émettre une lettre.',
      ),
      documents: ['T03'],
    },
    {
      ...
      body: bi(
        'For this tenure band, the ESA s. 57 statutory floor is 3 weeks of notice (or pay in lieu). Treat this as a minimum to meet or exceed — not as the right answer for every case. Common-law reasonable notice is often higher. Verify tenure and the statute before issuing a letter.',
        'Pour cette tranche d’ancienneté, le plancher légal de l’art. 57 de la LNE est de 3 semaines de préavis (ou d’indemnité). Traitez-le comme un minimum à respecter ou dépasser — pas comme la bonne réponse dans tous les cas. Le préavis raisonnable de common law est souvent plus élevé. Vérifiez l’ancienneté et la loi avant d’émettre une lettre.',
      ),
      documents: ['T03'],
    },
    {
      ...
      body: bi(
        'For this tenure band, the ESA s. 57 statutory floor is 4 weeks of notice (or pay in lieu). Treat this as a minimum to meet or exceed — not as the right answer for every case. Common-law reasonable notice is often higher. Verify tenure and the statute before issuing a letter.',
        'Pour cette tranche d’ancienneté, le plancher légal de l’art. 57 de la LNE est de 4 semaines de préavis (ou d’indemnité). Traitez-le comme un minimum à respecter ou dépasser — pas comme la bonne réponse dans tous les cas. Le préavis raisonnable de common law est souvent plus élevé. Vérifiez l’ancienneté et la loi avant d’émettre une lettre.',
      ),
      documents: ['T03'],
    },
    {
      ...
      body: bi(
        'For this tenure band, the ESA s. 57 statutory floor is 5 weeks of notice (or pay in lieu). Treat this as a minimum to meet or exceed — not as the right answer for every case. Common-law reasonable notice is often higher. Verify tenure and the statute before issuing a letter.',
        'Pour cette tranche d’ancienneté, le plancher légal de l’art. 57 de la LNE est de 5 semaines de préavis (ou d’indemnité). Traitez-le comme un minimum à respecter ou dépasser — pas comme la bonne réponse dans tous les cas. Le préavis raisonnable de common law est souvent plus élevé. Vérifiez l’ancienneté et la loi avant d’émettre une lettre.',
      ),
      documents: ['T03'],
    },
    {
      ...
      body: bi(
        'For this tenure band, the ESA s. 57 statutory floor is 6 weeks of notice (or pay in lieu). Treat this as a minimum to meet or exceed — not as the right answer for every case. Common-law reasonable notice is often higher. Verify tenure and the statute before issuing a letter.',
        'Pour cette tranche d’ancienneté, le plancher légal de l’art. 57 de la LNE est de 6 semaines de préavis (ou d’indemnité). Traitez-le comme un minimum à respecter ou dépasser — pas comme la bonne réponse dans tous les cas. Le préavis raisonnable de common law est souvent plus élevé. Vérifiez l’ancienneté et la loi avant d’émettre une lettre.',
      ),
      documents: ['T03'],
    },
    {
      ...
      body: bi(
        'For this tenure band, the ESA s. 57 statutory floor is 7 weeks of notice (or pay in lieu). Treat this as a minimum to meet or exceed — not as the right answer for every case. Common-law reasonable notice is often higher. Verify tenure and the statute before issuing a letter.',
        'Pour cette tranche d’ancienneté, le plancher légal de l’art. 57 de la LNE est de 7 semaines de préavis (ou d’indemnité). Traitez-le comme un minimum à respecter ou dépasser — pas comme la bonne réponse dans tous les cas. Le préavis raisonnable de common law est souvent plus élevé. Vérifiez l’ancienneté et la loi avant d’émettre une lettre.',
      ),
      documents: ['T03'],
    },
    {
