...
/* prettier-ignore */ const FinanceDeals = lazy(() => import('@/features/app/views/finance/screens/Deals').then((m) => ({ default: m.Deals })))
/* prettier-ignore */ const FinanceGovernance = lazy(() => import('@/features/app/views/finance/screens/Governance').then((m) => ({ default: m.Governance })))
  ...
  return [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'deals', element: <FinanceDeals /> },
        { path: 'governance', element: <FinanceGovernance /> },
