...
| `/app/finance` → `/app/finance/overview` · `/app/finance/transactions` · `/app/finance/sales` · `/app/finance/purchases` · `/app/finance/payroll` · `/app/finance/accounting` · `/app/finance/plans` · `/app/finance/treasury` · `/app/finance/tax` · `/app/finance/evidence`                                                                                                                                                       | Finance workspace (payroll / accounting / bookkeeping / budgets / spend / treasury / tax / evidence)                                                                                          |
