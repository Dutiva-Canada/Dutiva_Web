...
|| `/app/revenue`                                                                                                                                                                                                                                                                                                                                                               | Revenue workspace — overview linking CRM and Comms                                                                                       |
...
|| `/app/specialists` → `/app/specialists/directory` · `/app/specialists/engagements`                                                                                                                                                                                                                                                                                                                                                           | External specialists directory and engagement log                                                                                        |
