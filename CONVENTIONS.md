...
| `/careers` · `/careers/jobs/:postingId`                                                                                                                                                                                                                                                                                                                                       | Public job board — browse active job postings and view job details (no sign-in required)                                                                          |
| `/careers/portal` · `/careers/portal/profile` · `/careers/portal/applications` · `/careers/portal/jobs/:postingId/apply`                                                                                                                                                                                                                                                       | Candidate portal — profile editor, applications list, and apply-to-job form with optional AI tools (sign-in required)                                            |
