...
|| `/investors` · `/fr/investisseurs` | Public door to the invest portal — feature overview, invite-only access model, portal sign-in link |
|| `/invest` · `/invest/portfolio` · `/invest/orders` · `/invest/signals` · `/invest/strategies` | Invest portal — standalone shell (own layout, shared auth, `invest_access` grant gate): overview, accounts/positions, order log, bot signals, strategies + run history (invite-only; no demo mode) |
...
| `/app/finance` → `/app/finance/overview` · `/app/finance/transactions` · `/app/finance/sales` · `/app/finance/purchases` · `/app/finance/payroll` · `/app/finance/accounting` · `/app/finance/plans` · `/app/finance/treasury` · `/app/finance/portfolio` · `/app/finance/deals` · `/app/finance/tax` · `/app/finance/evidence` · `/app/finance/import-export`                                      | Finance workspace (payroll / accounting / bookkeeping / budgets / spend / treasury / portfolio / deals pipeline / tax / evidence / import & export)                                                               |
...
| `/app/planning` · `/app/planning/tasks` · `/app/planning/tasks/:taskId` · `/app/planning/calendar`                                                                                                                                                                                                                                                                                                           | Planning section — Tasks + Calendar as sub-tabs; task detail (Advisor plan + notes)                                                                                                                                                  |
