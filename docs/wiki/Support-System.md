...
The notification system supports 16 email kinds including `ticket_received`, `agent_reply`, `call_proposed`, `call_confirmed`, `privacy_ack`, `security_ack`, `operator_alert`, `beta_signup`, and `beta_confirmation`.
