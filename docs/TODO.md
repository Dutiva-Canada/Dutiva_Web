...
| Advisor Memory persistence (facts, audit, chat injection, case narratives)        | #196–#198 — `hr_advisor_memory_facts` / audit (`0086`), case narratives + timeline (`0087`), production Memory surfaces, `advisor-chat` injects confirmed facts and auto-extracts inferred candidates; workspace shows “Memory used”. Demo still session-scoped. Remaining: L5 corpus review, OA9 residency, demo gold highlights / export polish.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
