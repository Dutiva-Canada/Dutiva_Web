...
Generated 2026-09-20 by `scripts/document-db-structure.mjs` from the live
...
| Table | Cols | RLS | Policies |
| ----- | ---- | --- | -------- |
| `candidate_applications` | 10 | on | 5 |
| `candidate_profiles` | 17 | on | 4 |
| `candidate_resumes` | 8 | on | 4 |
...
| `public.candidate_resumes` | `update_candidate_resumes_updated_at` |
...
| `public.candidate_resumes` | Users can delete own candidate resumes | DELETE | public |
| `public.candidate_resumes` | Users can insert own candidate resumes | INSERT | public |
| `public.candidate_resumes` | Users can read own candidate resumes | SELECT | public |
| `public.candidate_resumes` | Users can update own candidate resumes | UPDATE | public |
...
| `public.hr_job_postings` | Public can read active job postings | SELECT | public |
