...
const MAX_EAGER_KB = 620 // 612 as of 2026-09-06; raised to 620 for the browser-local Transformer option (ruleSuggestionAi.ts controller + a few new workspace i18n strings). The ~40MB model and ONNX runtime stay in a lazy chunk, not the entry graph.
